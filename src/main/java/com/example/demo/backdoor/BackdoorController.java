...
public class BackdoorController {
    ...
    private void createProductOptionItems() {
        ...
        jdbcTemplate.update("""
                        ...
                        VALUES (?, ?, ?, ?, ?)
                        """,
                "0BV000ITEM002", "0BV000OPT0001", "red", now, now
        );
    ...
    private void createImages() {
        ...
        jdbcTemplate.update("""
                        ...
                        VALUES (?, ?, ?, ?, ?)
                        """,
                "0BV000IMG0001", "0BV000PRO0001", "https://ahastudio.github.io/my-image-assets/images/cbcl-products/01.jpg", now, now
        );
        ...
        jdbcTemplate.update("""
                        ...
                        VALUES (?, ?, ?, ?, ?)
                        """,
                "0BV000IMG0002", "0BV000PRO0002", "https://ahastudio.github.io/my-image-assets/images/cbcl-products/02.jpg", now, now
        );
