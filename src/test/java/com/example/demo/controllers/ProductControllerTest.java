...
class ProductControllerTest extends ControllerTest {
    ...
    void list() throws Exception {
        ProductSummaryDto productDto = new ProductSummaryDto(
                ...
                new ImageDto("https://ahastudio.github.io/my-image-assets/images/cbcl-products/01.jpg"),
                "Product",
                100_000L
        );
    ...
    void detail() throws Exception {
        ProductDetailDto productDto = new ProductDetailDto(
                "PRODUCT-ID",
                new CategoryDto("CATEGORY-ID", "Category"),
                List.of(new ImageDto("https://ahastudio.github.io/my-image-assets/images/cbcl-products/01.jpg")),
                "Product",
                100_000L,
                List.of(),
                ""
